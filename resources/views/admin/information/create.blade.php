...
<div class="container-fluid mt-4">
    <div class="card shadow-sm border-0 rounded-3">
        <div class="card-header d-flex justify-content-between align-items-center bg-primary text-white">
            <h4 class="mb-0" style="color: white">Add Information</h4>
            ...
            <form action="{{ route('admin.information.store') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="email_icon" class="form-control" value="{{ old('email_icon') }}">
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="linkedin_icon" class="form-control" value="{{ old('linkedin_icon') }}">
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="instagram_icon" class="form-control" value="{{ old('instagram_icon') }}">
                    </div>
