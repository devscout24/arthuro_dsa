...
<div class="container-fluid mt-4">
    ...
    <div class="card shadow-sm">
        ...
        <div class="card-header d-flex justify-content-between align-items-center">
            <h4 class="card-title mb-0">Edit Negotiable</h4>
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.negotiable.update', $negotiable->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="title" class="form-control" value="{{ old('title', $negotiable->title) }}" required>
                    </div>

                    <div class="col-md-12 mb-3">
                        <label class="form-label">Description</label>
                        <textarea name="description" class="form-control summernote" rows="6" required>{{ old('description', $negotiable->description) }}</textarea>
                    </div>
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        @php
                            $items = old('tagline', is_array($negotiable->tagline) ? $negotiable->tagline : []);
