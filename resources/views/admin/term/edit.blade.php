...
<div class="container-fluid mt-4">
    <div class="card shadow-sm border-0 rounded-3">
        <div class="card-header d-flex justify-content-between align-items-center bg-primary text-white">
            ...
            <a href="{{ route('admin.term.index') }}" class="btn btn-secondary btn-sm">Back</a>
        </div>
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.term.update', $term->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="description" class="form-control summernote" rows="5" required>{{ old('description', $term->description) }}</textarea>
                </div>
